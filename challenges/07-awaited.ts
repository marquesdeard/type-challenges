...
type MyAwaited<T> = T extends PromiseLike<infer B> ? MyAwaited<B> : T;

type ExampleOneT = MyAwaited<X>;
type ExampleTwoT = MyAwaited<Y>;
type ExampleThreeT = MyAwaited<Z>;
type ExampleFourT = MyAwaited<Z1>;
type ExampleFiveT = MyAwaited<T>;
