...
// For below typeof tuple example we were added readonly before keyword unknown array extend

// This is an array type. It represents an array, which can be any length. (unknown[])
