...
type ExampleOne = If<true, "a", "b">;
type ExampleTwo = If<false, "a", 2>;

// This is both true and false (like true | false), for this reason returns both value
type ExampleThree = If<boolean, "a", 2>;
